...
public class MemberRepositoryMain {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("findMember1 = " + findMember1); //findMember1 = Member{id='id1', name='회원1'}
        Member findMember3 = repository.findByName("회원3");
        System.out.println("findMember3 = " + findMember3); //findMember3 = Member{id='id3', name='회원3'}

        // 회원 삭제
        repository.remove("id1");
        Member removedMember1 = repository.findById("id1");
        System.out.println("removedMember1 = " + removedMember1); //removedMember1 = null
    }
}
